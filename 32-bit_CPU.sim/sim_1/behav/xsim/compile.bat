...
REM
REM Generated by Vivado on Sun Sep 14 11:47:47 -0700 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_top_level_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_top_level_vlog.prj -log xvlog.log
